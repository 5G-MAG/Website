...
These outputs are what 5G-MAG uses to ground its media and AI-traffic requirement inputs to 3GPP. Full detail, including the emulator YAML profile schema and the AI characterisation architecture, is on the [6G Testbed developer scope page](/developer/6g-testbed/scope).
