...
<h1>Video Library - Docs</h1>
</div>

## Overview

This library collects recorded talks from 5G-MAG workshops on 3GPP media and broadcast specifications. The videos are grouped by workshop, most recent first.

On this page:
* [Workshop - October 2025 - 3GPP Release 19, ready for implementation](#workshop---october-2025---3gpp-release-19-ready-for-implementation)
* [Workshop - December 2022 - 3GPP Release 16, 17 (and a bit of 18)](#workshop---december-2022---3gpp-release-16-17-and-a-bit-of-18)

## Workshop - October 2025 - 3GPP Release 19, ready for implementation

### Advanced Media Delivery series

The Advanced Media Delivery talks below were presented by Thomas Stockhammer (Qualcomm) with support from Jason Cloud (Dolby), Frédéric Gabin (Dolby) and Richard Bradbury (BBC); the QoS talk additionally had support from Rufael Mekuria (Huawei). The per-talk byline is stated once here rather than repeated under each video.
...
#### Advanced Media Delivery - Reminder on 5G Media Streaming
