...
A scoped, approved piece of standardisation work: it has an owning group, a rapporteur, defined objectives, and (usually) a target release. A Work Item is what eventually produces one or more specifications or specification updates. See [Meetings with 3GPP SA4](/tech/standards/3gpp-issue-tracking) for how 5G-MAG tracks these per release.
