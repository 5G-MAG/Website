...
<h1>6G Media</h1>
<p>5G-MAG tracks the early standardisation of media aspects for 6G systems and builds reference tooling to characterise Artificial Intelligence (AI) and media traffic on future networks.</p>
</div>
</div>
