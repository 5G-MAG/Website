...
sidebar_position: 1
description: Dated log of XCHANGE meetings between 5G-MAG and 3GPP SA4 tracking specification issues, CRs and their status.
---
...
This page is the running log of XCHANGE meetings, the regular sessions where 5G-MAG and 3GPP SA4 review the specification issues raised by implementers. Each section below is dated and listed newest first. Issue numbers link to the [5G-MAG Standards GitHub tracker](https://github.com/orgs/5G-MAG/projects/33), where the current status is always authoritative. For the Work Items that define what each 3GPP Release delivers, see [3GPP Work Items per Release](/tech/standards/3gpp-work-items).
...
* [XCHANGE 07/03/2024](#xchange-07032024)
* [XCHANGE 26/10/2023](#xchange-26102023)
* [XCHANGE 27/07/2023](#xchange-27072023)
* [XCHANGE 11/05/2023](#xchange-11052023)
* [XCHANGE 11/03/2023](#xchange-11032023)

### Status and milestone legend
...
The entries below use several 3GPP media-delivery shorthands. See the [5G Media Streaming standards page](/tech/standards/5gms) for fuller definitions.

* **5GMS** (5G Media Streaming); **5GMSd** (downlink) and **5GMSu** (uplink) are its two directions.
* **5MBS / MBS** (5G Multicast-Broadcast Services).
* **M1..M11**: reference points (named interfaces) in the 5G Media Streaming architecture, for example M1 (provisioning), M4 (media delivery), M5 (service access), M6 (media session handling) and M7 (media playback).
...
-- | -- | -- | --
[#104](https://github.com/5G-MAG/Standards/issues/104)|TS 26.512: M1 Policy Template Provisioning - Return codes for error handling of put operation | TS 26.512 Rel-17| -
...
-	Issues #148 and #149 are raised in the context of the feasibility analysis and usage guidelines for the deployment of Uplink 5G Media Streaming (5GMSu) and RTC architectures (as mentioned above) and as described by the Discussion Paper S4aI240135.
...
- [#79](https://github.com/5G-MAG/Standards/issues/79) 5GMSd - QoE Metrics Reporting - Inconsistency with `HTTPList`.

Published as TS 26.247 [V16.8.1](https://www.3gpp.org/dynareport/26247.htm26247-g81.zip) and [V17.4.1](https://www.3gpp.org/dynareport/26247.htm26247-h41.zip).
...
- [#87](https://github.com/5G-MAG/Standards/issues/87) 3GPP [TS 26.346](https://www.3gpp.org/dynareport/26346.htm) - Wrong RFC referenced for "Compact No-Code" FEC
...
- [#66](https://github.com/5G-MAG/Standards/issues/66) [TS 26.501](https://www.3gpp.org/dynareport/26501.htm) Clarification - Appropriate network entity for metrics error reports.
- [#75](https://github.com/5G-MAG/Standards/issues/75) Confusion over "nominal time period" validity for Network Assistance throughput estimations and delivery boosts

Published as TS 26.501 [V16.12.0](https://www.3gpp.org/dynareport/26501.htm26501-gc0.zip), [V17.7.0](https://www.3gpp.org/dynareport/26501.htm26501-h70.zip) and [18.3.1](https://www.3gpp.org/dynareport/26501.htm26501-i31.zip).
...
- [#65](https://github.com/5G-MAG/Standards/issues/65) TS 26.512 MetricsReportingConfiguration scheme cardinality does not match YAML definition
- [#67](https://github.com/5G-MAG/Standards/issues/67) TS 26.512 - Typo in word "Metrics" - Should be named "metrics".
- [#68](https://github.com/5G-MAG/Standards/issues/68) TS 26.512 - Clarification on the client behavior for the list of metrics which shall be reported
- [#69](https://github.com/5G-MAG/Standards/issues/69) TS 26.512 - Handling of 3XX HTTP redirects via interface at M2d
- [#71](https://github.com/5G-MAG/Standards/issues/71) TS 26.512 - How to choose a address from *clientConsumptionReportingConfiguration.serverAddresses* array for consumption reporting
- [#73](https://github.com/5G-MAG/Standards/issues/73) TS 26.512 - Consumption reporting: How is *aspId* for POST URL generated?
- [#74](https://github.com/5G-MAG/Standards/issues/74) Possible inconsistency in specification of Service Data Flow Description
- [#76](https://github.com/5G-MAG/Standards/issues/76) TS 26.512: *NetworkAssistanceSession* Request body not specified in the OpenAPI YAML for M5 *createNetworkAssistanceSession* operation
- [#78](https://github.com/5G-MAG/Standards/issues/78) 5GMSd - QoE Metrics Reporting - Clarification on sampling rate for buffer level
- [#80](https://github.com/5G-MAG/Standards/issues/80) 5GMS AF treatment of Network Assistance Session resource
- [#81](https://github.com/5G-MAG/Standards/issues/81) TS 26.512: Clarification on use of optional properties in NetworkAssistanceSession

Published as TS 26.512 [V16.11.0](https://www.3gpp.org/dynareport/26512.htm26512-gb0.zip) and [V17.6.0](https://www.3gpp.org/dynareport/26512.htm26512-h60.zip).

#### Discussions

- ~~[#49](https://github.com/5G-MAG/Standards/issues/49) Discussion Item: Signaling of DRM information via Service Access Information~~
- ~~[#63](https://github.com/5G-MAG/Standards/issues/63) Discussion: 5GMSd Network Assistance - Synergy with CTA-Wave Common Media Server Data (CMSD)~~
...
- [#45](https://github.com/5G-MAG/Standards/issues/45) Specify methods in the M6 Media Session Handling client API to invoke 5GMS network assistance
  - Maybe something in the next meeting cycle?
- [#61](https://github.com/5G-MAG/Standards/issues/61) TS 26.512 Policy Template state change events
  - Maybe add something in Rel-18?
- [#82](https://github.com/5G-MAG/Standards/issues/82) TS 26.512: Media streaming session identifier
...
- [#42](https://github.com/5G-MAG/Standards/issues/42) Specify client-facing 5GMS AF host name to be used by Media Session Handler at M5
  ...
  - (This change will probably end up in the new [TS 26.510](https://www.3gpp.org/dynareport/26510.htm) document.)

### New issues targeting approval at SA#102 Edinburgh

#### Recently raised issues for potential adoption by 5G-MAG and 3GPP SA4

- [#89](https://github.com/5G-MAG/Standards/issues/89) TS 26.512 - Make *externalReference* and *applicationSessionContext* optional properties of *PolicyTemplate* resource
- [#90](https://github.com/5G-MAG/Standards/issues/90) 5GMSd - Consumption Reporting - Clarification on duration property
- [#91](https://github.com/5G-MAG/Standards/issues/91) Clarification of *ConsumptionReportingUnit.mediaEndpointAddress* ambiguity
  - Discussion on the value of reporting endpoint address of both ends of reference point M4.
- [#97](https://github.com/5G-MAG/Standards/issues/97) TS 26.512 - Value of *mediaPlayerEntry* and *mediaConsumed* in Definition of ConsumptionReport format
...
1. [#86](https://github.com/5G-MAG/Standards/issues/86) TS 26.512: Fix inconsistent name of client metrics reporting configuration property in Service Access Information
   - Corrected simple typo in YAML.
2. [#88](https://github.com/5G-MAG/Standards/issues/88) TS 26.512 - Use of Read-only mandatory fields in *PolicyTemplate* resource
   - Piloted use of *readOnly* YAML directive.
4. [#93](https://github.com/5G-MAG/Standards/issues/93) M5 Service Access Information - Inconsistency with *ConsumptionReportingConfiguration.accessReporting*
5. [#94](https://github.com/5G-MAG/Standards/issues/94) Inadvisable use of response code 422 (Unprocessable Entity) by 5GMS AF at reference point M1
   - Replaced with different HTTP response codes.
7. [#95](https://github.com/5G-MAG/Standards/issues/95) Unclear binding between *externalReference* and Policy Template identifier in M5 Service Access Information
   - Introduced new *policyTemplateBindings* array to explicitly bind an external reference to a Policy Template identifier.
8. [#96](https://github.com/5G-MAG/Standards/issues/96) TS 26.512: M1 *ConsumptionReportingConfiguration.reportingInterval* value range not present in the OpenAPI YAML
   - Updated YAML to specify *reportingInterval* > 0.
12. [#33](https://github.com/5G-MAG/Standards/issues/33) Use of *aspId* and *externalApplicationId* in *M1_ProvisioningSession_createProvisioningSession*
...
- [#56](https://github.com/5G-MAG/Standards/issues/56) Specify mechanism for discovery of MBS User Service Announcement by MBS Client
  - Stage-2 procedures clarified during previous meeting cycle in [TS 26.502](https://www.3gpp.org/dynareport/26502.htm) V17.5.0 clause 5.4.
...
Published in TS 26.517 [V17.4.0](https://www.3gpp.org/dynareport/26517.htm26517-h40.zip).
...
- [#53](https://github.com/5G-MAG/Standards/issues/53) Applicability of Schedule Description metadata unit in MBS User Service Announcement is inconsistent
...
- [#54](https://github.com/5G-MAG/Standards/issues/54) Add a figure to illustrate JSON-based syntax of MBS User Service Announcement
...
- [#55](https://github.com/5G-MAG/Standards/issues/55) Clarify population of Schedule Description metadata unit in MBS User Service Announcement
  - Still not tackled.
  - Wholesale redraft in next revision of **TS 26.517 Rel-17 CR0001** will hopefully flush this issue out.
- [#57](https://github.com/5G-MAG/Standards/issues/57) Clarification of Byte Range Object Repair
...
- [#66](https://github.com/5G-MAG/Standards/issues/66) TS 26.501 Clarification - Appropriate network entity for metrics error reports.
...
- [#59](https://github.com/5G-MAG/Standards/issues/59) Disambiguate Media Player Entry data types at M1 and M5
- [#60](https://github.com/5G-MAG/Standards/issues/60) Clarification on TS 26.512 `ServiceAccessInformation.networkAssistanceConfiguration.serverAddresses` values
- [#62](https://github.com/5G-MAG/Standards/issues/62) TS 26.512 Policy Template state reasons
- [#64](https://github.com/5G-MAG/Standards/issues/64) TS 26.512: Signalling of `domainNameAliases` during server certificate creation

Published as **[TS 26.512](https://www.3gpp.org/dynareport/26512.htm V17.5.0**.
...
- ~~[#63](https://github.com/5G-MAG/Standards/issues/63) Discussion: 5GMSd Network Assistance - Synergy with CTA-Wave Common Media Server Data (CMSD)~~
  - ~~See discussion paper in [S4aI230122](https://www.3gpp.org/ftp/TSG_SA/WG4_CODEC/3GPP_SA4_AHOC_MTGs/SA4_MBS/Docs/S4aI230122.zip).~~
- ~~[#72](https://github.com/5G-MAG/Standards/issues/72) Discussion: TS 26.512 - How is consumption reporting triggered?~~
...
- [#33](https://github.com/5G-MAG/Standards/issues/33) Use of `aspId` and `externalApplicationId` in *M1_ProvisioningSession_createProvisioningSession*
...
- [#71](https://github.com/5G-MAG/Standards/issues/71) TS 26.512 - How to choose a address from `clientConsumptionReportingConfiguration.serverAddresses` array for consumption reporting
  - Historical precedent for QoE metrics reporting in [TS 26.247](https://www.3gpp.org/dynareport/26247.htm) annex F is random selection for load balancing.
- [#73](https://github.com/5G-MAG/Standards/issues/73) TS 26.512 - Consumption reporting: How is `aspId` for POST URL generated?
...
- [#78](https://github.com/5G-MAG/Standards/issues/78) 5GMSd - QoE Metrics Reporting - Clarification on sampling rate for buffer level
  ...
  - This would align TS 26.512 Rel-17 with Charles Lo's final **[TS 26.532](https://www.3gpp.org/dynareport/26532.htm) Rel-17 CR0003**.
  - Should this change also be made to TS 26.512 Rel-16?
- [#75](https://github.com/5G-MAG/Standards/issues/75) TS 26.512: Network Assistance recommendation and boost time windows
...
Published as **[TS 26.517](https://www.3gpp.org/dynareport/26517.htm V17.3.0**.
...
### Quick update on Reference Tools
  * Progress implementing the 5G Media Streaming specifications:
    * Reference Tools at a glance: https://hub.5g-mag.com/Getting-Started/
    ...
    * [End to End Setup for 5G Media Streaming (Android)](https://hub.5g-mag.com/Getting-Started/pages/5g-media-streaming/)
...
### Issues to be covered at the session
See [Kanban board](https://github.com/orgs/5G-MAG/projects/33).
...
* Support **development** and **implementation** work (https://hub.5g-mag.com/Getting-Started/)
* Bring specs to life with **demos** and **trials** (https://www.5g-mag.com/tutorials)
* Provide **specification feedback** to 3GPP (https://www.5g-mag.com/standards - https://github.com/orgs/5G-MAG/projects/33)

### Reference Tools: achievements so far
...
* There are also basic reference implementations of the **Media Player** and **Media Session Handler** for Android.
  ...
  * The setup uses a single index.json file that only contains provisioningSessionIDs, mediaPlayerEntry and the M5 URL.
...
* Help SA4 spec development based on developers’ feedback. Our GitHub tracker is open to anyone: https://github.com/orgs/5G-MAG/projects/33
