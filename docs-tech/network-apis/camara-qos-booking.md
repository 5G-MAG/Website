...
The QoS Booking API definition (YAML) is available at: [https://github.com/camaraproject/QoSBooking/blob/main/code/API_definitions/qos-booking.yaml](https://github.com/camaraproject/QoSBooking/blob/main/code/API_definitions/qos-booking.yaml)
