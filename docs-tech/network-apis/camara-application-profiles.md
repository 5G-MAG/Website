...
The Application Profiles API definition (YAML) is available at: [https://github.com/camaraproject/ApplicationProfiles/blob/main/code/API_definitions/application-profiles.yaml](https://github.com/camaraproject/ApplicationProfiles/blob/main/code/API_definitions/application-profiles.yaml)
