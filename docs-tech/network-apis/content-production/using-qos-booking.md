...
<figure>
  <img src="./images/figure_qosbooking.png" width="80%" alt="High-level architecture for QoS Booking, showing the media application (ASP) invoking the Network API Platform to create a device-bound QoS booking." />
