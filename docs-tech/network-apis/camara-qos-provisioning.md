...
The QoS Provisioning API definition (YAML) is available at: [https://github.com/camaraproject/QualityOnDemand/blob/main/code/API_definitions/qos-provisioning.yaml](https://github.com/camaraproject/QualityOnDemand/blob/main/code/API_definitions/qos-provisioning.yaml)
