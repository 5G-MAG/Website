...
<p>Reference implementation of the User Equipment (UE) side data collection, reporting, and event exposure framework defined in 3GPP TS 26.531 and TS 26.532.</p>
</div>
</div>
