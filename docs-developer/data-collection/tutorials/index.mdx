...
export const communityVideos = [
  { id: 'ZpktgeRCqNY', title: 'Docker Setup with Insomnia REST Client - UE Data Collection', by: 'Video walkthrough of the Docker + Insomnia setup; it covers the same ground as the written tutorial above.' },
  { id: 'FFnyln0YB1A', title: 'UE Data Collection, Reporting and Event Exposure', by: 'Overview talk introducing UE data collection, reporting and event exposure.' },
];
