...
<img src="/assets/images/dcaf/uedc_docker_1.png" style="width: 80%" alt="Docker setup for the DCAF tutorial, showing the DCAF, NRF and HTTP/2 server containers" />
...
You have run the DCAF end to end: registering it with the NRF, provisioning a session and configuration (R1), subscribing to events (R6), and submitting a data report (R2) that was delivered to the HTTP/2 server.
