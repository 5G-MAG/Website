...
This glossary collects the acronyms and terms that recur across the developer portal. Definitions are short and plain-language; consult the linked topic pages or the referenced specifications for full detail.
