...
export const communityVideos = [
  { id: 'hkVgL8yq0V8', title: 'Emergency Alerts over 5G Broadcast embedded in DVB-T2 at IBC 2025', by: 'Demo of emergency alerts over 5G Broadcast embedded in a DVB-T2 signal, shown at IBC 2025.' },
  { id: 'O0qrTlmYKpA', title: 'Emergency Alerts over 5G Broadcast at FOKUS Media Web Symposium 2024', by: 'Demo of emergency alerts over 5G Broadcast, shown at the FOKUS Media Web Symposium 2024.' },
];
