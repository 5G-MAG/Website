...
export const communityVideos = [
  { id: 'uEfBaTqh5vw', title: 'Overview of the latest updates to the 5G Media Streaming Project - Reference Tools' },
  { id: 'SOA7OGF86Gg', title: 'Introducing the new 5GMS Application Provider Portal - Reference Tools' },
  ...
  { id: 'qewsQhGi8aE', title: 'Introducing the 5GMS Application Provider Management Portal - Reference Tools' },
  { id: 'fv_LoZXk5Oc', title: '5GMS Consumption Reporting, Network Assistance and Dynamic Policies - Reference Tools' },
  { id: 'lJG1hNty_AU', title: '5G Media Streaming supported by Reference Tools - DEVELOPER XCHANGE' },
  { id: 'L5nGVf-WhNE', title: '5G Media Streaming End-to-end setup with Android clients - Reference Tools' },
  { id: '2IU_18Dvhew', title: '5G Media Streaming in the BBC R&D standalone testbed - Reference Tools' },
];
