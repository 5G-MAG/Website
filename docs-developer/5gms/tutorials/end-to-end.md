...
the [documentation](../tutorials/testing-AS#testing-with-the-application-function). We are following
...
Now that we have the server-side setup in place we can focus on the client side. We need to install four components (two
