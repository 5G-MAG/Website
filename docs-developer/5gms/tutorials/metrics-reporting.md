...
very [basic user interface](https://github.com/5G-MAG/rt-5gms-application-provider/tree/development/qoe-metrics-reporting-ui)
...
*Figure: the QoE Metrics Reporting UI visualising an individual report.*
