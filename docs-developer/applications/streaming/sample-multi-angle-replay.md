...
<a class="community-tile" href="/developer/5gms/tutorials/end-to-end">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 5a9 4 0 0 0 18 0a9 4 0 0 0 -18 0" /><path d="M3 5v14a9 4 0 0 0 18 0v-14" /></svg>
<strong>AF + AS</strong>
...
<a class="community-tile" href="/developer/5gms/tutorials/consumption-reporting">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18" /><path d="M20 18v3" /><path d="M16 16v5" /><path d="M12 13v8" /><path d="M8 16v5" /><path d="M3 11l6 -6l4 4l8 -8" /></svg>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 19v-8a2 2 0 0 1 2 -2h4v10m-6 0h16m-6 0v-6a2 2 0 0 1 2 -2h4v8" /></svg>
...
* Complete the [5GMSd (with Docker) tutorial](/developer/5gms/tutorials/end-to-end) — this showcase builds on that deployment rather than repeating its setup.
* Complete [5G Media Streaming with Consumption Reporting](/developer/5gms/tutorials/consumption-reporting).
...
* [5GMSd (with Docker)](/developer/5gms/tutorials/end-to-end)
* [5G Media Streaming with Consumption Reporting](/developer/5gms/tutorials/consumption-reporting)
