...
<div class="project-grid">
  ...
  <div class="project-card">
    ...
    <div class="project-card__footer">
      <a class="button button--outline button--primary" href="../network-apis/">Documentation</a>
      <a class="button button--outline button--primary" href="https://github.com/orgs/5G-MAG/projects/48/views/19">Roadmap</a>
      <a class="button button--outline button--primary" href="../network-apis/releases">Releases</a>
    </div>
  </div>
