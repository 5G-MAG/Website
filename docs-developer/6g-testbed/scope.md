...
Example YAMLs with the pre-defined profiles used by the AI traffic characterization testbed are available here: [https://github.com/5G-MAG/6G-Testbed/blob/main/aitestbed/configs/profiles.yaml](https://github.com/5G-MAG/6G-Testbed/blob/main/aitestbed/configs/profiles.yaml)
...
* [GitHub Repos](./repositories): the source repositories
