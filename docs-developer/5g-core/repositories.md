...
The table below lists the source repositories for the 5G Core Service Consumer libraries and their command-line tools. Auxiliary repositories are supporting libraries or helper tools rather than primary deliverables, and are indicated with a dashed border.
