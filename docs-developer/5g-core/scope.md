...
[To the GitHub Repos](./repositories)
...
4. Build the libraries into your own application from the [GitHub repositories](./repositories) once the tools confirm the core responds as expected.
