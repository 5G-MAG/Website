...
3. Use the source in the [GitHub repositories](./repositories) and the built [packages](./packages) for the individual components (MBSTF, MB-SMF/MB-UPF over Open5GS, and the service consumer libraries).
