...
The reference tools cover DVB-I service discovery and selection, bootstrap procedures, and integration with both the 5GMS unicast path and the 5G Broadcast path, so that a hybrid broadcast and broadband TV experience can be demonstrated end to end. See the [GitHub Repos](./repositories) page for the available repositories and the [Project Roadmap](./projects) for planned work.
...
* **Unicast delivery**: handing a DVB-DASH service instance to the 5G Media Streaming client path. The 5GMS behaviour itself lives in the [5G Media Streaming reference tools](../5gms/repositories).
* **Broadcast delivery**: acquiring a broadcast service instance over the LTE-based 5G Broadcast path. The receiver/modem behaviour lives in the [5G Broadcast reference tools](../5g-broadcast/repositories).
