...
<p>5G Broadcast delivers linear TV and radio to an unlimited number of devices over a free-to-air radio signal, with no SIM and no per-user connection or return channel.</p>
</div>
</div>
