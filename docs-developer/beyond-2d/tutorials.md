...
- For the current repositories and their READMEs, see the [GitHub Repos](./repositories) page.
- For what the framework evaluates and the specifications it tracks, see the [Scope](./scope) page.
- Related encoding and rendering walkthroughs are available for the [V3C Immersive Platform](../v3c/tutorials/).
