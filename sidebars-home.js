...
const sidebars = {
    ...
    { type: 'link', label: 'Overview', href: '/applications' },
    {
      ...
      items: [
        ...
        },
        {
          ...
          link: { type: 'doc', id: 'applications/5g-broadcast' },
          items: [{ type: 'autogenerated', dirName: 'applications/5g-broadcast' }],
        },
  ...
  referenceToolsSidebar: [
    ...
    },
    {
      ...
      link: { type: 'doc', id: 'reference-tools/content-delivery/index' },
      collapsed: true,
      items: [{ type: 'autogenerated', dirName: 'reference-tools/content-delivery' }],
    },
