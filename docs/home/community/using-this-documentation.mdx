...
The **Releases** section lists the latest published version of each repository in the project, with dates. It draws on the same data as the [Releases](/community#projects) section on the Community page.
