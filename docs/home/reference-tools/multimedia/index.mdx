...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname://../../docs/Reference_Tools_Multimedia_delivery_protocols.pdf" title="Multimedia Delivery Protocols: project overview slide deck"></iframe>
</div>

<a class="button button--outline button--primary" href="pathname:///docs/Reference_Tools_Multimedia_delivery_protocols.pdf" style={{margin: '4px 0'}}>Download the slide deck of this Project</a>
