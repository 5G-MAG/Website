...
- [rt-libflute Implementation](/reference-tools/multimedia/rt-libflute-implementation) &mdash; explanation of what the FLUTE library implements, checked against those specifications
