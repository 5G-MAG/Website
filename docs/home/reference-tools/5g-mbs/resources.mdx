...
hide_title: true
sidebar_position: 1
description: Source repositories, packages and latest releases for the 5G Multicast Broadcast Services project.
---
...
Source repositories, packages and latest releases for the 5G Multicast Broadcast Services Reference Tools. Please refer to the [Scope](./scope) page for context on how these components fit together.

## Repositories

The following repositories are available. Please refer to the "Scope" section of the different projects for more context.

The table below lists the MBS reference tools and links each one to its source repository. Auxiliary repositories are supporting libraries or helper tools rather than primary deliverables, and are marked with an Auxiliary badge.
...
#### MB-SMF Service Consumer Library

[rt-5gc-service-consumers](https://github.com/5G-MAG/rt-5gc-service-consumers)

This library implements the MB-SMF service-consumer side of Nmbsmf_TMGI and Nmbsmf_MBSSession (3GPP TS 29.532). It is vendored as a subproject inside the MBSF, providing the alternative to provisioning the 5GC directly; see the [5GC Service Consumers tutorial](../5g-core/tutorials/using-libscMBSMF).

Additional information:

- [Information and how to download, build, install and run](https://github.com/5G-MAG/rt-5gc-service-consumers#readme)
- [Packages](https://github.com/orgs/5G-MAG/packages?repo_name=rt-5gc-service-consumers)
...
<ProjectReleases name="5G Multicast Broadcast Services (MBS)" />
