...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname://../../docs/Reference_Tools_5G_Multicast_Broadcast.pdf" title="5G Multicast Broadcast Services reference tools overview slide deck"></iframe>
</div>

<a class="button button--outline button--primary" href="pathname:///docs/Reference_Tools_5G_Multicast_Broadcast.pdf" style={{margin: '4px 0'}}>Download the slide deck of this Project</a>
