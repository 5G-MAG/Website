...
<OnAirTeaser videoId="e_xK_ckkhgc" title="Demonstrating MBS User Service Announcement mechanisms - Reference Tools" href="/reference-tools/5g-mbs/tutorials#developer-exchange" by="Dev Audsin, David Waring and Richard Bradbury (BBC R&D)" />
