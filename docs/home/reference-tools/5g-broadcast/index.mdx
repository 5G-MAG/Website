...
<a class="button button--outline button--primary" href="pathname:///docs/Reference_Tools_5G_Broadcast.pdf" style={{margin: '4px 0'}}>Download the slide deck of this Project</a>
