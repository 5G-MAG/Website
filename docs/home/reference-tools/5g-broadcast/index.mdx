...
<img loading="lazy" src="/assets/images/5gbc/reference-tools-broadcast-demo.jpg" alt="5G Broadcast Reference Tools transmitter hardware, with a phone running the 5G-MAGflix demo app" style={{width: '100%', borderRadius: '12px', margin: '1rem 0'}} />
