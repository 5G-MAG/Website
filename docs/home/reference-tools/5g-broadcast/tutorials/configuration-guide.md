...
hide_title: true
sidebar_position: 6
description: Configuration reference for the Service Announcement file and FLUTE ffmpeg watchfolder across HLS, DASH, and seamless-switching delivery modes.
---
