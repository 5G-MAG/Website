...
<img loading="lazy" src={useBaseUrl('/assets/images/5gbc/rt-wui-mw-tab.jpg')} width="800" alt="Web User Interface Middleware tab showing the received stream information"/>

_Figure: the Middleware tab of the Web User Interface, showing the received stream._

<img loading="lazy" src={useBaseUrl('/assets/images/5gbc/rt-wui-playback.jpg')} width="800" alt="Web User Interface playing the HLS stream with hls.js"/>
