...
<p align="center"><img loading="lazy" src={useBaseUrl('/assets/images/5gbc/reference-ors.png')} alt="Photo of the ORS reference setup: an Intel NUC with an integrated SDR and display"/></p>
