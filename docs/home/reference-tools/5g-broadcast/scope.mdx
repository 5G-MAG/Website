...
Relevant specifications are listed on the standards portal pages below.
...
| -------------- | ---- | --------- |
| TS 103 720 &mdash; 5G Broadcast System for linear TV and radio services (the FeMBMS waveform implemented by rt-mbms-tx and rt-mbms-modem) | ETSI | [etsi.org standards search](https://www.etsi.org/standards-search#search=103%20720) |
