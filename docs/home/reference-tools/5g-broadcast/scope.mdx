...
<img loading="lazy" src={useBaseUrl('/assets/images/projects/5gbc_diagram.png')} alt="Architecture combining the 5G Broadcast transmitter and modem with FLUTE-based multimedia delivery protocols" style={{width: '80%'}}/>
...
- Standards: [Multimedia Delivery Protocols](/standards/multimedia) — the FLUTE/ROUTE transports that carry content over the broadcast bearer
