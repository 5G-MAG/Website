...
- **Used in:** [Broadcast Stream Playback (RTP/HLS)](/applications/5g-broadcast#broadcast-stream-playback-rtphls), [Seamless Unicast/Broadcast Switching](/applications/5g-broadcast#seamless-unicastbroadcast-switching)
