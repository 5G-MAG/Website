...
<div style={{margin: '8px 0'}}><a class="button button--primary" href={useBaseUrl('/reference-tools/common-tools/scope')} style={{margin: '2px 4px 2px 0'}}>Scope</a> <a class="button button--outline button--primary" href={useBaseUrl('/reference-tools/common-tools/resources')} style={{margin: '2px 4px 2px 0'}}>Resources</a></div>
