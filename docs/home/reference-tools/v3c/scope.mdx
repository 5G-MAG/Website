...
The V3C reference tools relate to the following specifications. For the full, maintained list, see the [Volumetric Video with V3C](/tech/standards/v3c) page.
...
- **Used in:** [Volumetric Video Streaming to Android](/applications/volumetric#volumetric-video-streaming-to-android)
