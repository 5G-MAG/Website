...
The reference tools cover DVB-I service discovery and selection, bootstrap procedures, and integration with both the 5GMS unicast path and the 5G Broadcast path, so that a hybrid broadcast and broadband TV experience can be demonstrated end to end. See the [Resources](./resources) page for the available repositories and the [Roadmap](#roadmap) for planned work.
