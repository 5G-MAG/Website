...
The normative behaviour the tools implement comes from these individual DVB, ETSI and 3GPP specifications; the full list is also linked from [Standards: DVB-I Services over 5G Systems](/tech/standards/dvb-i).
