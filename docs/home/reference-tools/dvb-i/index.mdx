...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname://../../docs/Reference_Tools_DVB_I_over_5G.pdf" title="DVB-I over 5G: project overview slide deck"></iframe>
</div>

<a class="button button--outline button--primary" href="pathname:///docs/Reference_Tools_DVB_I_over_5G.pdf" style={{margin: '4px 0'}}>Download the slide deck of this Project</a>
