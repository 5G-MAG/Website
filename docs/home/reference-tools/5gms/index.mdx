...
<OnAirTeaser videoId="uEfBaTqh5vw" title="Overview of the latest updates to the 5G Media Streaming Project - Reference Tools" href="/reference-tools/5gms/tutorials#developer-exchange" by="Daniel Silhavy (5G-MAG WG DEV Chair, Fraunhofer Fokus)" />
