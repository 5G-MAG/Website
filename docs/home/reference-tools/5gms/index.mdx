...
<VideoGrid videos={[{ id: 'uEfBaTqh5vw', title: 'Overview of the latest updates to the 5G Media Streaming Project - Reference Tools', by: 'Daniel Silhavy (5G-MAG WG DEV Chair, Fraunhofer Fokus)' }]} />
