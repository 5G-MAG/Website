...
- The generic UE data collection and event exposure framework (TS 26.531 and TS 26.532) is provided as a separate project and is not yet wired into 5GMS; see the "Feature: Data collection, reporting and exposure" section.
...
| -------------- | ----- | -------------------------------------------------------------- |
| TS 26.501      | 3GPP  | [https://www.3gpp.org/dynareport/26501.htm](https://www.3gpp.org/dynareport/26501.htm) |
| TS 26.512      | 3GPP  | [https://www.3gpp.org/dynareport/26512.htm](https://www.3gpp.org/dynareport/26512.htm) |
| TS 26.511      | 3GPP  | [https://www.3gpp.org/dynareport/26511.htm](https://www.3gpp.org/dynareport/26511.htm) |
| TS 26.510      | 3GPP  | [https://www.3gpp.org/dynareport/26510.htm](https://www.3gpp.org/dynareport/26510.htm) |
| TS 26.531      | 3GPP  | [https://www.3gpp.org/dynareport/26531.htm](https://www.3gpp.org/dynareport/26531.htm) |
| TS 26.532      | 3GPP  | [https://www.3gpp.org/dynareport/26532.htm](https://www.3gpp.org/dynareport/26532.htm) |

- **TS 26.501** covers the architecture, functional entities and features.
- **TS 26.512** covers the M1 provisioning APIs, the M5 session-handling APIs and the AS configuration. In Release 17 the session-handling APIs live in TS 26.512; **TS 26.510** does not exist in Release 17 (in Release 18 the session-handling APIs move into TS 26.510 and are generalised across 5GMS and RTC).
- **TS 26.511** covers profiles, codecs and formats of the delivered media.
- **TS 26.531 / TS 26.532** define the generic UE data collection and event exposure framework, provided as a separate project (see [UE Data Collection, Reporting and Event Exposure](../data-collection/scope)) and not yet wired into 5GMS.
...
- Standards: [5G Media Streaming specifications](/standards/5gms)
