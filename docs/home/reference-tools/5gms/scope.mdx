...
- **Used in:** [Live Streaming Over a Real 5G Network](/applications/streaming#live-streaming-over-a-real-5g-network), [QoE Analytics Dashboard](/applications/streaming#qoe-analytics-dashboard)
