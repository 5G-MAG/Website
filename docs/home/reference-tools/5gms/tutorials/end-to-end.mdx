...
<h1>5GMSd End-to-End deployment (with Docker)</h1>
</div>
</div>
...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/5gms-docker-recipe1.png')} alt="Diagram of the 5GMS Docker Compose recipe1 setup showing the Application Function, Application Server, and Application Provider containers" style={{width: '80%'}}/>
...
### 4. Configuring the Application Function
...
<img loading="lazy" width="757" alt="5GMSd-Aware Application UI on Android showing a stream selected and playing" src={useBaseUrl('/assets/images/5gms/5gms-ui.png')}/>
...
- [5GMSd End-to-End deployment with 5G Network](./end-to-end-with-5g)
