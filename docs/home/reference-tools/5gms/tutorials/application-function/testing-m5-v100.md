...
<h1>Testing: M5 Interface (5GMSd Application Function v1.0.0 to v1.1.x)</h1>
</div>
</div>
...
However, in this version of the 5GMSd Application Function there is only one provisioning session created at start up. The
...
:::note
The single-session-at-startup behaviour described here applies only to v1.0.0 to v1.1.x. From v1.2.x onwards, provisioning sessions are created dynamically with the `m1-session` tool; see [Testing M5 (v1.2.x)](./testing-m5-v120) and [Testing M5 (v1.3.0 and above)](./testing-m5-v130).
:::
