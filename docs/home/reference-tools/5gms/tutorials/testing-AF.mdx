...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/5GMS_Downlink_AF.png')} alt="5GMSd downlink architecture highlighting the Application Function and its M1, M3 and M5 interfaces" />
