...
<div style={{ margin: '8px 0' }}>
  <a
    ...
    href="/reference-tools/5gms/scope"
  ...
  <a
    class="button button--outline button--primary"
    href="/reference-tools/5gms/resources"
    style={{ margin: '2px 4px 2px 0' }}
  >
    Resources
  </a>{' '}
  <a
    class="button button--outline button--primary"
    href="/reference-tools/5gms/tutorials"
    style={{ margin: '2px 4px 2px 0' }}
  >
    Tutorials
  </a>{' '}
  <a
    class="button button--outline button--primary"
    href="/reference-tools/5gms/tutorials#developer-exchange"
    style={{ margin: '2px 4px 2px 0' }}
  >
    Developer Exchange
  </a>
