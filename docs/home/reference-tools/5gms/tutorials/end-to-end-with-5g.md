...
Follow the [basic configuration steps](end-to-end#5-configuration-of-the-af) documented in
the [basic end-to-end guide](end-to-end).

### Step 5: Start the Application Function

Follow the [command](end-to-end#6-starting-the-af) documented in the [basic end-to-end guide](end-to-end).

### Step 6: Create a Content Hosting Configuration and Provisioning Session

Follow the [steps](end-to-end#7-creating-a-content-hosting-configuration) to create a content hosting configuration
