...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/5GMS_Downlink_AS.png')} alt="5GMSd downlink architecture highlighting the Application Server and its M2d, M3 and M4d reference points" />
...
- Put the AS into a full deployment: [5GMSd End-to-End deployment (with Docker)](./end-to-end).
