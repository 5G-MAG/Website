...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/5GMS_Downlink_ConsumptionReporting.png')} alt="5GMSd downlink with Consumption Reporting: the Media Player logging consumption and the client sending reports to the AF" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/postman-env.png')} alt="Screenshot of the Postman Environments panel showing the provisioning_session_id variable" width="80%" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/postman-m1-consumption.png')} alt="Screenshot of the Postman client sending the M1 Create Consumption Reporting Configuration request" width="80%" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/postman-m5-consumption.png')} alt="Screenshot of the Postman client showing the M5 GET Service Access Information response with clientConsumptionReportingConfigurations" width="80%" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/5gms/app-playback.png')} width="30%" alt="5GMSd-Aware Application playing a stream on Android while consumption reports are generated" />
