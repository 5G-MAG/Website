...
The tools demonstrate how a media application server interacts with the 5G Core (the Policy Control Function (PCF), Network Exposure Function (NEF) and Binding Support Function (BSF)) to request network resources dynamically and receive notifications about network events affecting media delivery.
