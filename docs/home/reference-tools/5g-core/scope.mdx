...
- **TMGI**: Temporary Mobile Group Identity, the identifier for an MBS session.
  :::
...
How the service-consumer libraries sit between a media Application Function and the 5G Core in each deployment.
...
- [Resources](/reference-tools/5g-core/resources)
- [Tutorials](/reference-tools/5g-core/tutorials)
- Standards: [5G Media Streaming (5GMS)](/standards/5gms) and [5G Multicast Broadcast Services (MBS)](/standards/5g-mbs) — this project provides service-consumer libraries that call 5G Core service-based APIs rather than implementing a specification of its own; the BSF and PCF service-consumer interfaces are documented on the 5GMS page, and the MB-SMF service-consumer interface on the MBS page
- Tech: [Streaming & Media Delivery](/tech/5gms) and [Multicast & Broadcast in 5G](/tech/5g-mbs)
