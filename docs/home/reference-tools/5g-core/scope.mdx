...
This project provides service-consumer libraries that call 5G Core service-based APIs rather than implementing a 3GPP specification itself, so no specific 3GPP or ETSI document numbers are cited on this page. The BSF and PCF service-consumer interfaces are documented on the [Standards: 5G Media Streaming](/standards/5gms) page, and the MB-SMF service-consumer interface is documented on the [Standards: 5G Multicast & Broadcast Services](/standards/5g-mbs) page.
...
- Standards: [5G Media Streaming (5GMS)](/standards/5gms) and [5G Multicast Broadcast Services (MBS)](/standards/5g-mbs) — the service-consumer interfaces this project implements are documented there
