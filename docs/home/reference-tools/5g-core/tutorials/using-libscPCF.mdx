...
<img loading="lazy" src={useBaseUrl('/assets/images/5gcsc/PCC_rules.png')} style={{width: '80%'}} alt="Open5GS WebUI showing the PCC rules configured for 5QI 2 (video) used by the PCF Policy Authorization example"/>
