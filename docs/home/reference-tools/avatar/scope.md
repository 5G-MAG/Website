...
hide_title: true
sidebar_position: 0
description: Explains what MPEG ARF (ISO/IEC 23090-39) covers and how the Avatar Communication tools split into capture, transport, and rendering components.
---
