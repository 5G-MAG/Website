...
| Area           | Details                                                                                                                                                                                                    |
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Standards**   | This platform's two branches implement the RAN/Core layer for [5G Multicast Broadcast Services (MBS) on the Standards portal](/tech/standards/5g-mbs) and [5G Broadcast on the Standards portal](/tech/standards/5g-broadcast). |
