...
Next, install the driver and firmware for your specific SDR board — pick the one you have:

<div class="community-tiles community-tiles--even">
<a class="community-tile" href="#using-bladerf-with-soapy">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M11 12a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M16.616 13.924a5 5 0 1 0 -9.23 0" /><path d="M20.307 15.469a9 9 0 1 0 -16.615 0" /><path d="M9 21l3 -9l3 9" /><path d="M10 19h4" /></svg>
<strong>BladeRF</strong>
<span class="tile-desc">Install the soapysdr-module-bladerf package, then add the Nuand PPA to install the BladeRF firmware.</span>
<span class="tile-cta">BladeRF setup →</span>
</a>
<a class="community-tile" href="#using-limesdr-with-soapy">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M11 12a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M16.616 13.924a5 5 0 1 0 -9.23 0" /><path d="M20.307 15.469a9 9 0 1 0 -16.615 0" /><path d="M9 21l3 -9l3 9" /><path d="M10 19h4" /></svg>
<strong>LimeSDR</strong>
<span class="tile-desc">Build Lime Suite from source at a pinned commit — the apt package causes calibration errors on LimeSDR Minis.</span>
<span class="tile-cta">LimeSDR setup →</span>
</a>
<a class="community-tile" href="#using-hackrf-one-with-soapy">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M11 12a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M16.616 13.924a5 5 0 1 0 -9.23 0" /><path d="M20.307 15.469a9 9 0 1 0 -16.615 0" /><path d="M9 21l3 -9l3 9" /><path d="M10 19h4" /></svg>
<strong>HackRF One</strong>
<span class="tile-desc">Install the HackRF Soapy module and verify detection; note its half-duplex clock-synchronisation considerations.</span>
<span class="tile-cta">HackRF setup →</span>
</a>
</div>

## Using BladeRF with Soapy

For BladeRF the relevant package is named _soapysdr-module-bladerf_. Install it by running:
...
Lime Suite needs to be built from source at a specific commit. _Do not_ use the package available through apt, as the version it packages does not seem to work reliably with LimeSDR Minis and causes calibration errors and unreliable reception. Please follow these steps:

<a class="repo-card repo-card--inline" href="https://github.com/myriadrf/LimeSuite">
<span class="repo-card__name"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.833.092-.647.35-1.088.636-1.338-2.221-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0 1 12 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.02 10.02 0 0 0 22 12.017C22 6.484 17.522 2 12 2z" /></svg>LimeSuite</span>
...
After installing rt-mbms-modem, you must modify the rt-mbms configuration parameter in `/etc/5gmag-rt.conf`. Build and install steps are in its repository:
...
<span class="repo-card__role">Build and install steps for the FeMBMS receiver used with these SDR configurations.</span>
</a>
...
<div><strong>Your SDR hardware is installed and verified.</strong> BladeRF, LimeSDR or HackRF One is ready to use with srsRAN-based tools.</div>
</div>

## Next steps

- Return to [5G Network](./5gnetwork) to build a private 5G network using this radio hardware.
