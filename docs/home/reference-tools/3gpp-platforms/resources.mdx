...
hide_title: true
sidebar_position: 1
description: Roadmap notes, source repository forks (Open5GS, srsRAN, srsRAN_4G), branch mapping, and release status for the 3GPP RAN and Core Platforms project.
---
...
Roadmap notes, source repository forks and latest releases for the 3GPP RAN and Core Platforms project. Please refer to the [Scope](./scope) page for context on how these components fit together.

## Repositories

The following repositories are available. Please refer to the "Scope" section of this project for more context. The table below lists the 5G-MAG forks of the upstream RAN and Core software; when the automation has run, it shows each repository with its links and status.

<ProjectRepositories project="3gpp-platforms" />
