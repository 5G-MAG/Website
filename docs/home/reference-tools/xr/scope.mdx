...
The XR reference tools relate to the specifications below. For the full, maintained list, see the [Standards: XR Media with MPEG-I Scene Description](/standards/xr) page.

| Specification | Body | Reference |
| --- | --- | --- |
| ISO/IEC 23090-14 | ISO/IEC (MPEG) | [MPEG-I Scene Description](https://www.iso.org/standard/86439.html) |
| ISO/IEC 12113 (glTF 2.0) | Khronos Group | [glTF 2.0 specification](https://registry.khronos.org/glTF/specs/2.0/glTF-2.0.html) |
