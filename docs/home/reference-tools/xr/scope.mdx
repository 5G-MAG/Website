...
The Scene Description format standardized by [ISO/IEC JTC 1/SC29/WG03](https://www.iso.org/committee/45316.html) MPEG Systems in [ISO/IEC 23090-14](https://www.iso.org/standard/90191.html) specifies a framework for composing 3D scenes for immersive experiences. It supports anchoring 3D assets in the real world, rich interactivity, and real-time media delivery.
