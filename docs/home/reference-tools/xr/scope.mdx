...
The XR reference tools relate to the specifications below. For the full, maintained list, see the [Standards: XR Media with MPEG-I Scene Description](/tech/standards/xr) page.
...
- Tech: [XR: 3D Scenes and Avatar Communications](/tech/xr)
- Standards: [XR Media with MPEG-I Scene Description](/tech/standards/xr)
- **Used in:** [Immersive 3D Media Messaging](/applications/volumetric#immersive-3d-media-messaging), [XR Content Authoring with Blender](/applications/volumetric#xr-content-authoring-with-blender)
