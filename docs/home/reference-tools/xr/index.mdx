...
<img loading="lazy" src="/assets/images/xr/volumetric-capture-demo.jpg" alt="Volumetric capture demo running on the 5G-MAG Reference Tools" style={{width: '100%', maxWidth: '500px', display: 'block', margin: '1rem auto', borderRadius: '12px'}} />
