...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname://../../docs/Reference_Tools_XR_Media_MPEG_I_SD.pdf" title="XR Media MPEG-I Scene Description: project overview slide deck"></iframe>
</div>

<a class="button button--outline button--primary" href="pathname:///docs/Reference_Tools_XR_Media_MPEG_I_SD.pdf" style={{margin: '4px 0'}}>Download the slide deck of this Project</a>
