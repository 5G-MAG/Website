...
<a class="button button--outline button--primary" href="pathname:///docs/Reference_Tools_UE_data_collection.pdf" style={{margin: '4px 0'}}>Download the slide deck of this Project</a>
