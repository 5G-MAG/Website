...
| **Standards**               | TS 26.531/532 and event exposure specs: [UE Data Collection on the Standards portal](/standards/data-collection)                                     |
| **Testbeds**                 | Complementary evaluation activities that consume this data rather than reimplementing it: [AI/ML Evaluation Framework](/testbeds/ai-ml) and [6G Testbed](/testbeds/6g-testbed) |
