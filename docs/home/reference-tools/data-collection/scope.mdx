...
The reference tooling implements the 3GPP SA4 data collection and reporting framework, targeting a 3GPP Release 18 profile.
...
| TS 29.517      | 3GPP | [https://www.3gpp.org/dynareport/29517.htm](https://www.3gpp.org/dynareport/29517.htm) |
| TS 23.288      | 3GPP | [https://www.3gpp.org/dynareport/23288.htm](https://www.3gpp.org/dynareport/23288.htm) |

- **TS 26.531** - Data Collection and Reporting; General Description and Architecture (the stage-2 architecture: functional entities and the R1 to R6 reference points).
- **TS 26.532** - Data Collection and Reporting; Protocols and Formats (the stage-3 APIs and data models, including `Ndcaf_DataReportingProvisioning` and `Ndcaf_DataReporting`).
- **TS 29.517** - Application Function Event Exposure Service; Stage 3 (the `Naf_EventExposure` API used for event exposure at R6, with the `Nnef_EventExposure` variant when exposing through the NEF).
- **TS 23.288** - Architecture enhancements for network data analytics services (the NWDAF, a typical Event Consumer at R5).

The event exposure API links in the interface sections below resolve to the Rel-17 and Rel-18 `5GC_APIs` OpenAPI definitions; use the Rel-18 definitions when a matching version is available.
...
<img loading="lazy" src={useBaseUrl('/assets/images/dcaf/UEDC_RT.png')} alt="DCAF functional blocks, with implemented blocks marked by a green tick" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/dcaf/usage-sequence-diagram.png')} alt="Sequence diagram of the DCAF usage flow across provisioning, subscription and reporting phases" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/projects/uedc_diagram.png')} style={{width: '80%'}} alt="Standalone DCAF architecture, with the Data Collection AF connected to a UE and a consuming Application Service Provider" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/projects/5gms_uedc_diagram.png')} style={{width: '80%'}} alt="DCAF integrated with the 5G Downlink Media Streaming data reporting framework" />
...
<img loading="lazy" src={useBaseUrl('/assets/images/dcaf/uedc_docker_1.png')} style={{width: '80%'}} alt="Docker-Compose deployment of the Data Collection AF and supporting containers" />
...
- [Resources](/reference-tools/data-collection/resources)
- [Tutorials](/reference-tools/data-collection/tutorials)
- Standards: [UE Data Collection, Reporting and Event Exposure](/standards/data-collection)
