...
- Standards: [UE Data Collection, Reporting and Event Exposure](/standards/data-collection) — the full specification list; the reference tooling implements the 3GPP SA4 data collection and reporting framework, targeting a 3GPP Release 18 profile
