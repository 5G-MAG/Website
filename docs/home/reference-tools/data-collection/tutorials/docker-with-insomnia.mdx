...
<img loading="lazy" src={useBaseUrl('/assets/images/dcaf/uedc_docker_1.png')} style={{width: '80%'}} alt="Docker setup for the DCAF tutorial, showing the DCAF, NRF and HTTP/2 server containers" />
