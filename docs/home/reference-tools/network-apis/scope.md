...
**Implemented specifications:** [CAMARA Dedicated Networks API](https://github.com/camaraproject/DedicatedNetworks), 3GPP TS 23.434 (SEAL for network capability exposure to applications). See the [Standards & Specifications](#standards--specifications) table below for details.
...
| ------------------------------------------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------- |
| CAMARA Dedicated Networks API                            | CAMARA (Linux Foundation / GSMA) | [https://github.com/camaraproject/DedicatedNetworks](https://github.com/camaraproject/DedicatedNetworks) |
| TS 23.434 - SEAL (network capability exposure to applications) | 3GPP                             | [https://www.3gpp.org/dynareport/23434.htm](https://www.3gpp.org/dynareport/23434.htm)             |
