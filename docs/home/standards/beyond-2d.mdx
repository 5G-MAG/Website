...
import { BEYOND_2D_SPECS, BEYOND_2D_LAYER_ORDER } from '@site/src/data/specs/beyond-2d';
...
<div class="godeeper-card__body">
<p>The evaluation framework that encodes, packages, delivers, decodes, renders and measures beyond-2D formats.</p>
<ul class="godeeper-card__links">
...
The study evaluates each format with the codecs that are practical for it today; for stereoscopic video, simulcast/frame-compatible HEVC serves as the anchor against MV-HEVC:

| Format family             | Coding approaches evaluated                                                          | Relation to V3C                                    |
| ------------------------- | ------------------------------------------------------------------------------------ | --------------------------------------------------- |
| Stereoscopic              | MV-HEVC; simulcast/frame-compatible HEVC as the anchor                               | Not V3C-based                                       |
...
<SpecIndex specs={BEYOND_2D_SPECS} layerOrder={BEYOND_2D_LAYER_ORDER} />
