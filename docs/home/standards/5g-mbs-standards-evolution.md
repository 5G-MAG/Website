...
| Rel-19 | Non-terrestrial network (NTN) extensions to MBS broadcast, tracked as part of the general **NTN Phase 3** feature rather than a dedicated MBS work item; see [MBS Broadcast over NTN](/tech/ntn/analysis-mbs-broadcast-over-ntn) for the technical detail. No Rel-19 MBS work item beyond this has been found. |
