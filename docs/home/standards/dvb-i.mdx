...
| End-to-end native-IP composite system    | DVB A180 (DVB-NIP), reusing DVB-I, DVB-DASH and DVB-MABR together         |
...
- [Standardisation](/standards): how 5G-MAG processes feedback on the specifications it tracks
