...
slug: /standards/content-delivery
...
import { CONTENT_DELIVERY_SPECS, CONTENT_DELIVERY_LAYER_ORDER } from '@site/src/data/specs/content-delivery';
...
<li><a href="/tech/content-delivery">Tech: Content Delivery Protocols</a></li>
</ul>
</div>
</div>
<div class="godeeper-card">
...
<SpecIndex specs={CONTENT_DELIVERY_SPECS} layerOrder={CONTENT_DELIVERY_LAYER_ORDER} />
...
5G-MAG tracks these transport and format specifications and their use across its 5G Broadcast and 5G MBS work. See [Tech: Content Delivery Protocols](/tech/content-delivery) for the implementer-facing analysis. Contributions to this documentation are made through the [5G-MAG Standards repository](https://github.com/5G-MAG/Standards/).
...
- [Tech: Content Delivery Protocols](/tech/content-delivery)
