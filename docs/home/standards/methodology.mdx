...
<div class="topic-lead">
  How a GitHub issue raised against a 5G-MAG or external SDO specification is reviewed and carried
  through to a correction, new-feature proposal or liaison input.
</div>
...
<img
  loading="lazy"
  src={useBaseUrl('/assets/images/Feedback_1.png')}
...
<img
  loading="lazy"
  src={useBaseUrl('/assets/images/Feedback_2.png')}
