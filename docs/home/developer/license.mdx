...
<div style={{display: 'flex', gap: '1.5rem', alignItems: 'center', flexWrap: 'wrap'}}>
  <img loading="lazy" style={{flex: '1 1 60%', minWidth: '260px'}} src={useBaseUrl('/assets/images/Reference_Tools_Contributors.png')} alt="Logos of the official contributors to the 5G-MAG Reference Tools" />
  <img loading="lazy" style={{flex: '1 1 30%', minWidth: '160px'}} src={useBaseUrl('/assets/images/Reference_Tools_Members.png')} alt="Logos of the 5G-MAG member organizations" />
</div>
