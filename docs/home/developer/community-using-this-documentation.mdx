---
id: developer-community-using-this-documentation
slug: /community/using-this-documentation
...
The **Roadmap** section connects you to our GitHub project boards. Major features are tracked via the [Reference Tools Roadmaps board](https://github.com/orgs/5G-MAG/projects/48), and developers may also use sub-project boards to monitor granular progress. The [Roadmap](/community#roadmap) section on the Community page brings these boards together in one place.
...
The **Releases** section lists the latest published version of each repository in the project, with dates. It draws on the same data as the [Releases](/community#releases) section on the Community page.
