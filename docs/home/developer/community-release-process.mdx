---
id: developer-community-release-process
slug: /community/release-process
...
The status of the different software releases can be found on the [Community](/community#releases) page.
