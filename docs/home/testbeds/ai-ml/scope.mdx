...
| -------------- | -------- | ------------------------------------------------------ |
| TR 26.927 | 3GPP SA4 | [TR 26.927](https://www.3gpp.org/dynareport/26927.htm) |
| TR 26.847 | 3GPP SA4 | [TR 26.847](https://www.3gpp.org/dynareport/26847.htm) |
...
For context: TR 26.927 (Study on Artificial Intelligence and Machine Learning in 5G media services, Release 19) is the source of the media AI/ML scenarios and traffic-characterisation goals the tools address, and TR 26.847 (Evaluation of Artificial Intelligence and Machine Learning in 5G media services, Release 19) is its companion evaluation report. TR 22.874 (Study on traffic characteristics and performance requirements for AI/ML model transfer) frames the latency and data-rate behaviour to measure. TS 26.531 / TS 26.532 (Data Collection and Reporting) are implemented in the separate Data Collection project that feeds training and inference data. TS 23.288 (NWDAF, network-side analytics) provides context for how network data analytics would consume this kind of data.
