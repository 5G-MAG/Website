...
- Standards: [AI & ML in 5G Media](/standards/ai-ml) — the full list of the 3GPP studies and specifications that define the scenarios and data this activity evaluates
