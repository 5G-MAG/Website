...
A list of relevant specifications can be found on the standards portal: [Standards: 6G Media](/standards/6g).
...
| -------------- | -------- | ------------------------------------------------------ |
| TS 23.501 | 3GPP SA2 | [TS 23.501](https://www.3gpp.org/dynareport/23501.htm) |
...
The standards portal gives the full picture for these references: [6G Media](/standards/6g) and [AI & ML in 5G Media](/standards/ai-ml).
...
- [6G on the Standards portal](/standards/6g): the standards context
