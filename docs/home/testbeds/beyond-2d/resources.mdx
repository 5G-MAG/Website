...
<div style={{ margin: '8px 0' }}>
  ...
  <a
    class="button button--outline button--primary"
    href="/testbeds/beyond-2d/resources"
    style={{ margin: '2px 4px 2px 0' }}
  >
    Resources
  </a>{' '}
  <a
    class="button button--outline button--primary"
    href="/testbeds/beyond-2d/tutorials"
    style={{ margin: '2px 4px 2px 0' }}
  >
    Tutorials
  </a>
...
Project roadmap, source repositories and latest releases for the Beyond 2D Evaluation Framework Reference Tools. Please refer to the [Scope](./scope) page for context on how these components fit together.
