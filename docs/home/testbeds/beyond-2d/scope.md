...
hide_title: true
sidebar_position: 0
description: Explains the Beyond 2D Evaluation Framework's test scenarios, codecs, and metrics for benchmarking stereoscopic, point-cloud, and multi-view-plus-depth video.
---
...
<div style="margin: 8px 0"><a class="button button--primary" href="/testbeds/beyond-2d/scope" style="margin: 2px 4px 2px 0">Scope</a> <a class="button button--outline button--primary" href="/testbeds/beyond-2d/resources" style="margin: 2px 4px 2px 0">Resources</a> <a class="button button--outline button--primary" href="/testbeds/beyond-2d/tutorials" style="margin: 2px 4px 2px 0">Tutorials</a> <a class="button button--outline button--primary" href="/testbeds/beyond-2d/tutorials#developer-exchange" style="margin: 2px 4px 2px 0">Developer Exchange</a></div>
