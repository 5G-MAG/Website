...
| Dynamic meshes        | V-DMC (ISO/IEC 23090-29), described alongside V-PCC for the volumetric scenario | V-DMC is V3C-related |
...
- Standards: [Beyond 2D Video](/standards/beyond-2d) — the full, maintained list of the specifications and work items behind this framework (FS_Beyond2D, TR 26.956, ISO/IEC 23090-5)
