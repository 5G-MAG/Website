...
**DASH/HLS Interoperability** — Common CMAF segments consumable by both DASH and HLS players, guided by CTA WAVE's [CTA-5005-A](https://web.archive.org/web/20240807060102/https://shop.cta.tech/products/web-application-video-ecosystem-dash-hls-interoperability-specification-cta-5005-a) specification and MPEG-DASH Part 9 (ReAP), studied for impact on the 5GMS System and MBS/MBMS distribution.
