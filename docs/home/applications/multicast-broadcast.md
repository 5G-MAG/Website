...
<div class="project-grid">
  ...
  <div class="project-card">
    <a class="project-card__icon-band" href="/reference-tools/5g-mbs/">
      ...
      <span>5G Multicast Broadcast Services (MBS)</span>
    </a>
    <div class="project-card__body"><p>5G MBS client and network functions for native multicast delivery.</p></div>
    <div class="project-card__footer">
      <a class="button button--outline button--primary" href="/reference-tools/5g-mbs/">Documentation</a>
      <a class="button button--outline button--primary" href="https://github.com/orgs/5G-MAG/projects/48/views/13">Roadmap</a>
      <a class="button button--outline button--primary" href="/reference-tools/5g-mbs/resources">Releases</a>
    </div>
  </div>
