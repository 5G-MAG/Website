...
<ul class="godeeper-card__links">
<li><a href="/standards/avatar">Standards: Avatar Communications</a></li>
</ul>
</div>
</div>
...
- [Standards: Avatar Communications](/standards/avatar): the standards-tracking view of this topic.
