...
**Reference tools:** The 5G-MAG software implementation is on the Developer Portal under [XR/3D Scenes with MPEG-I Scene Description](/reference-tools/xr).
...
<ul class="godeeper-card__links">
<li><a href="/standards/xr">Standards: XR and MPEG-I Scene Description</a></li>
</ul>
</div>
</div>
...
<ul class="godeeper-card__links">
<li><a href="/reference-tools/xr">XR/3D Scenes with MPEG-I Scene Description</a></li>
</ul>
</div>
</div>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src={useBaseUrl('/docs/Reference_Tools_XR_Media_MPEG_I_SD.pdf')} title="Slide deck: XR Media and MPEG-I Scene Description reference tools"></iframe>
</div>
...
- **VideoTech:** [Teaser on 5G and XR (3GPP Release 16/17/18)](./exchanges#teaser-on-5g-and-xr-3gpp-release-161718)
...
- [MPEG-I Scene Description: A dynamic scene description framework for immersive media](https://www.ibc.org/accelerating-innovation/reports/mpeg-i-scene-description-a-dynamic-scene-description-framework-for-immersive-media/22562), by T. Stockhammer (Qualcomm), I. Bouazizi (Qualcomm), M.-L. Champel (Xiaomi), E. Potetsianakis (Nokia), E. Thomas (Xiaomi), L. Kondrad (Nokia), E. Alexiou (TNO), G. Martin-Cocher (InterDigital), G. Bhullar (InterDigital), Q. Avril (InterDigital), Q. Galvane (InterDigital), J. Regateiro (InterDigital), P. Hirtzlin (InterDigital)
