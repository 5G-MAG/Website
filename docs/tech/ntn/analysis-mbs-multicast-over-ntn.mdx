...
<img loading="lazy" src={useBaseUrl('/img/tech/ntn/figure_MBS_Multicast_NTN.png')} width="80%" alt="MBS Multicast over NTN: an Application Service Provider provisions multicast services into the NTN 5G Core, which the Donor gNodeB delivers to UEs over point-to-point or point-to-multipoint." />
