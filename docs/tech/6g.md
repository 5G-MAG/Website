...
**Reference tools:** An experimental testbed is available on the developer portal under [AI Traffic Characterization](/testbeds/6g-testbed).
...
<li><a href="/standards/6g">Standards: Towards 6G Media</a></li>
</ul>
</div>
</div>
...
<ul class="godeeper-card__links">
<li><a href="/testbeds/6g-testbed">6G Testbed &amp; AI Traffic</a></li>
</ul>
</div>
</div>
...
| [TR 26.847](https://www.3gpp.org/dynareport/26847.htm) | SA4   | 5G media AI/ML | Evaluation of AI and ML in 5G media services; evaluation testbeds, scenarios and metrics       |
...
TR 26.847 and TR 22.874 matter for 6G because two of the new IMT-2030 scenarios (immersive communication and AI and communication) drive traffic that these studies already characterise: high-rate media flows on one side, and model transfer flows on the other. See the [Standards: AI/ML in 5G Media](/standards/ai-ml) page for the interface and procedure detail.
...
These outputs are what 5G-MAG uses to ground its media and AI-traffic requirement inputs to 3GPP. Full detail, including the emulator YAML profile schema and the AI characterisation architecture, is on the [6G Testbed developer scope page](/testbeds/6g-testbed/scope).

## Related

- [5G Multicast Broadcast Services (MBS)](/tech/5g-mbs): 5G-native MBS, one of the delivery mechanisms expected to evolve towards 6G.
- [5G Broadcast](/tech/5g-broadcast): LTE-based broadcast delivery and its evolution.
- [Standards: Towards 6G Media](/standards/6g): the standards-tracking view of this topic.
