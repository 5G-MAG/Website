...
<div>
<h1 class="topic-hero__title">Towards 6G Media</h1>
</div>
</header>
...
**Reference tools:** An experimental testbed is available on the developer portal under [6G Testbed & AI Traffic](/testbeds/6g-testbed).
