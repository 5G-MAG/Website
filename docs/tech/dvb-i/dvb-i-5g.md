...
<div>
<h1 class="topic-hero__title">DVB-I Services over 5G Systems</h1>
</div>
</header>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname:///docs/Reference_Tools_DVB_I_over_5G.pdf" title="DVB-I over 5G reference tools overview slide deck"></iframe>
</div>
...
[Project: DVB-I Services over 5G Systems](/reference-tools/dvb-i)
