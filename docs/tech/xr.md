...
**Reference tools:** The 5G-MAG software implementation is on the Developer Portal under [XR Media Integration in 5G](/reference-tools/xr).
...
<ul class="godeeper-card__links">
<li><a href="/reference-tools/xr">XR Media Integration in 5G</a></li>
</ul>
</div>
</div>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname:///docs/Reference_Tools_XR_Media_MPEG_I_SD.pdf" title="Slide deck: XR Media and MPEG-I Scene Description reference tools"></iframe>
</div>

_Slide deck: XR Media and MPEG-I Scene Description reference tools._
...
- [glTF 2.0 extension in MPEG and 3GPP](https://www.khronos.org/assets/uploads/developers/presentations/glTF_2.0_Extensions_in_MPEG_and_3GPP_.pdf), a Khronos Group presentation
