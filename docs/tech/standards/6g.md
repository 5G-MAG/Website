...
5G-MAG tracks the early standardisation of media aspects for 6G systems. 6G work in 3GPP is currently at the study stage (technical reports on use cases and service requirements), so the focus here is on the relevant 3GPP studies rather than finished specifications, for anyone following how media and AI traffic requirements are shaping the next generation of mobile systems. For acronyms used here, see the [Glossary](/tech/glossary).
