...
<div>
<h1 class="topic-hero__title">5G Broadcast - TV, Radio and Emergency Alerts</h1>
</div>
</header>
...
**Reference tools:** The 5G-MAG software implementation is on the developer portal under [LTE-based 5G Broadcast](/reference-tools/5g-broadcast) and [Emergency Alerts](/reference-tools/emergency-alerts).
