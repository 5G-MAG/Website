...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname:///docs/Reference_Tools_UE_data_collection.pdf" title="UE Data Collection reference tools overview slide deck"></iframe>
</div>
...
[Project: UE data collection, reporting and event exposure](/reference-tools/data-collection)
