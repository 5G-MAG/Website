...
The 3GPP DCAF architecture for UE data collection and reporting, and how the network exposes the resulting events to consumers such as the NWDAF.
</div>
...
**Key specifications:** 3GPP [TS 26.531](https://www.3gpp.org/dynareport/26531.htm) (Data Collection and Reporting, architecture), [TS 26.532](https://www.3gpp.org/dynareport/26532.htm) (protocols and formats).

**Reference tools:** the [UE Data Collection reference tools](/reference-tools/data-collection) implement the DCAF standalone and integrated with 5GMSd.
...
<p>The DCAF architecture, the R1-R6 reference points, and how UE data is reported and exposed as events, below.</p>
</div>
</div>
...
<div class="godeeper-card__body">
<p>Normative 3GPP specs (TS 26.531, TS 26.532) and 5G-MAG's contributions on data collection.</p>
<ul class="godeeper-card__links">
<li><a href="/standards/data-collection">Standards: UE Data Collection, Reporting and Event Exposure</a></li>
</ul>
</div>
</div>
...
<div class="godeeper-card__body">
<p>Reference DCAF implementation, standalone or integrated with 5GMSd.</p>
<ul class="godeeper-card__links">
<li><a href="/reference-tools/data-collection">UE Data Collection, Reporting and Event Exposure</a></li>
</ul>
</div>
</div>
...
- **Indirect Data Collection Client** - a subfunction of the Application Service Provider's server that collects data from UE Applications (at reference point R8) and reports it onward to the DCAF.
...
The reference points are the named interfaces between the DCAF and the surrounding entities. The framework groups them by role: provisioning (R1), data reporting (R2, R3, R4) and event exposure (R5, R6). The table below is this page's [implementation blueprint](/tech/blueprints): for each reference point it names the endpoints, the service/API that operates over it, and what it does.
...
| R3              | Indirect Data Collection Client (ASP server) ↔ DCAF | `Ndcaf_DataReporting` (TS 26.532)                                                          | Fetch configuration and submit reports collected from UE Applications (via R8).             |
...
- [**UE Data Collection and Reporting framework for Event Exposure (3GPP Release 17)**](../exchanges#ue-data-collection-and-reporting-framework-for-event-exposure-3gpp-release-17)

## Related

- [Standards: UE Data Collection, Reporting and Event Exposure](/standards/data-collection): the specification list for this topic
- [UE Data Collection, Reporting and Event Exposure Reference Tools](/reference-tools/data-collection): the software implementation
- [5G Media Streaming (5GMS)](/tech/5gms): the media delivery framework this data collection serves
