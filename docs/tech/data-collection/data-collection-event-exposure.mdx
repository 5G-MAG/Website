...
<li><a href="/tech/standards/data-collection">Standards: UE Data Collection, Reporting and Event Exposure</a></li>
</ul>
</div>
</div>
...
<ul class="godeeper-card__links">
<li><a href="/reference-tools/data-collection">Project: UE data collection, reporting and event exposure</a></li>
</ul>
</div>
</div>
