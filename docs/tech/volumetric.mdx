...
:::tip[Start here]
New to volumetric video? Start with the [V3C standards tracking page](/standards/v3c) for the specifications in scope, or the [Beyond 2D Video](./volumetric/beyond-2d) tech page for the evaluation work. Implementers can find the reference software on the Developer Portal (linked under Reference tools below).
:::
...
<ul class="godeeper-card__links">
<li><a href="/standards/v3c">Standards: Volumetric Video with MPEG V3C</a></li>
<li><a href="/standards/beyond-2d">Standards: Beyond 2D Video</a></li>
</ul>
</div>
</div>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src={useBaseUrl('/docs/Reference_Tools_V3C_Immersive_Platform.pdf')} title="Slide deck: MPEG V3C Immersive Platform reference tools"></iframe>
</div>
...
- [Standards: Volumetric Video with MPEG V3C](/standards/v3c): the standards-tracking view of this topic.
- [Standards: Beyond 2D Video](/standards/beyond-2d): the standards-tracking view of the Beyond 2D evaluation work.
