...
sidebar_position: 14
hide_title: true
description: Describes 5G-MAG's Beyond 2D Video evaluation framework for benchmarking stereoscopic, multi-view, depth, and point-cloud video formats.
---
...
<span class="topic-banner__kicker">Volumetric Video with MPEG V3C</span>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname:///docs/Reference_Tools_Beyond2D_Video_Evaluation.pdf" title="Slide deck: Beyond 2D Video evaluation framework"></iframe>
</div>

_Slide deck: Beyond 2D Video evaluation framework._
...
[Project: Beyond 2D Evaluation Framework](/testbeds/beyond-2d)
...
:::note
Detailed technical documentation for this area is not yet published here. For the latest material, see the slide deck above, the [Beyond 2D Evaluation Framework project](/testbeds/beyond-2d), and the [Standards: Beyond 2D Video Experiences](/tech/standards/beyond-2d) page.
:::
