...
The 5G-MAG work provides an evaluation framework for benchmarking encoding, streaming, and rendering pipelines for these formats. It relates to the 3GPP study captured in [TR 26.956](https://www.3gpp.org/dynareport/26956.htm) (Evaluation and Characterization of Beyond 2D Video Formats and Codecs), published as a Release 19 Technical Report (V19.0.1, October 2025).
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src={useBaseUrl('/docs/Reference_Tools_Beyond2D_Video_Evaluation.pdf')} title="Slide deck: Beyond 2D Video evaluation framework"></iframe>
</div>
...
:::note
Detailed technical documentation for this area is not yet published here. For the latest material, see the slide deck above, the [Beyond 2D Evaluation Framework project](/testbeds/beyond-2d), and the [Standards: Beyond 2D Video Experiences](/standards/beyond-2d) page.
:::
...
- **Stereoscopic video**: a left and right view giving a fixed 3D effect but no free viewpoint. Coded with MV-HEVC or, as an anchor, frame-compatible or simulcast HEVC.
...
- **Dynamic meshes**: a volumetric representation using time-varying textured 3D meshes, coded with V-DMC (Video-based Dynamic Mesh Coding, ISO/IEC 23090-29), described alongside V-PCC for the volumetric scenario.

The volumetric and MV+D families are where this work overlaps with V3C: V-PCC, MIV and V-DMC are the V3C-related coding approaches evaluated for those cases. See the [Volumetric Video](../volumetric) parent page for how V3C, V-PCC, and MIV work.
...
- [Standards: Beyond 2D Video Experiences](/standards/beyond-2d): the standards-tracking view of this topic.
