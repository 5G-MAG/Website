...
- CAMARA Project: [Application Profiles project page](https://camaraproject.org/application-profiles/) and [GitHub repository](https://github.com/camaraproject/ApplicationProfiles)
...
- CAMARA Project: [Connectivity Insights project page](https://camaraproject.org/connectivity-insights/) and [GitHub repository](https://github.com/camaraproject/ConnectivityInsights)
...
- CAMARA Project: [Connectivity Insights Subscriptions project page](https://camaraproject.org/connectivity-insights-subscriptions/) and [GitHub repository](https://github.com/camaraproject/ConnectivityInsights)
...
- CAMARA Project: [Dedicated Networks project page](https://camaraproject.org/dedicated-networks/) and [GitHub repository](https://github.com/camaraproject/DedicatedNetworks)
...
- CAMARA Project: [Network Slice Booking project page](https://camaraproject.org/network-slice-booking/) and [GitHub repository](https://github.com/camaraproject/NetworkSliceBooking)
...
- CAMARA Project: [QoS Booking project page](https://camaraproject.org/qos-booking/) and [GitHub repository](https://github.com/camaraproject/QoSBooking)
...
- CAMARA Project: [QoS Booking and Assignment project page](https://camaraproject.org/qos-booking-and-assignment/) and [GitHub repository](https://github.com/camaraproject/QoSBooking)
...
- CAMARA Project: [QoS Profiles project page](https://camaraproject.org/qos-profiles/) and [GitHub repository](https://github.com/camaraproject/QualityOnDemand)
...
- CAMARA Project: [QoS Provisioning project page](https://camaraproject.org/qod-provisioning/) and [GitHub repository](https://github.com/camaraproject/QualityOnDemand)
...
- CAMARA Project: [Quality on Demand project page](https://camaraproject.org/quality-on-demand/) and [GitHub repository](https://github.com/camaraproject/QualityOnDemand)
