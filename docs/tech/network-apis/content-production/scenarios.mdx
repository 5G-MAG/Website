...
<img loading="lazy" src={useBaseUrl('/img/tech/network-apis/content-production/figure_newsgathering.png')} alt="Diagram of the single-device connectivity scenario showing a smartphone as the production device used for newsgathering/mobile journalism, connecting via the network to the studio production hub." width="60%"/>

The following figure represents a scenario where the device is a backpack.

<img loading="lazy" src={useBaseUrl('/img/tech/network-apis/content-production/figure_cellularbonding.png')} alt="Diagram of the single-device connectivity scenario showing a cellular bonding backpack as the production device, connecting via the network to the studio production hub." width="60%"/>
...
<img loading="lazy" src={useBaseUrl('/img/tech/network-apis/content-production/figure_outdoorbroadcast.png')} alt="Diagram of the multi-device connectivity scenario for outside broadcast, showing multiple production devices connected to the network for a coordinated production." width="60%"/>
