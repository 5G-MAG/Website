...
sidebar_position: 6
hide_title: true
description: Describes how the CAMARA QoS Booking and Assignment API reserves capacity for a device count, then assigns devices during production.
---
...
<h1>QoS Booking and Assignment</h1>
</div>
</div>
