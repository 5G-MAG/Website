...
Information: [QoS Profiles project page](https://camaraproject.org/qos-profiles/) and [GitHub repository](https://github.com/camaraproject/QualityOnDemand)
...
The QoS Profiles API definition (YAML) is available at: [qos-profiles.yaml](https://github.com/camaraproject/QualityOnDemand/blob/main/code/API_definitions/qos-profiles.yaml)
