...
**Reference tools:** The 5G-MAG software implementation is on the developer portal under [5G Multicast Broadcast Services](/reference-tools/5g-mbs).
...
<li><a href="./5g-mbs/mbs-service-layer">Service Layer Aspects</a></li>
<li><a href="./5g-mbs/mbs-service-system-aspects">Service &amp; System Aspects</a></li>
...
For the 3GPP specification list grouped by layer, see [Standards: 5G Multicast Broadcast Services](/tech/standards/5g-mbs). The [developer portal](/reference-tools/5g-mbs) covers what the reference software implements.
