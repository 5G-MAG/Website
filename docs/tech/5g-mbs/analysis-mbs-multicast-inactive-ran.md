...
## Control Plane Procedures [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
...
### RRC: MBS Multicast [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]

#### Acquisition of MBS Broadcast information via MCCH [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
...
#### Broadcast MRB configuration [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
...
#### PDCP: MBS Broadcast [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
...
#### RLC: MBS Broadcast [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
...
#### MAC: MBS Broadcast [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
...
## User Plane Procedures [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]

### SDAP: MBS Broadcast [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
...
### PDCP: MBS Broadcast (user plane) [NEEDS CORRECTION — currently describes Broadcast, not Multicast-Inactive]
