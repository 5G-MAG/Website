...
One item remains unverified: the placement of the broadcast and multicast session life-cycles in TS 23.247 Clauses 4.2 and 4.3 (TS 23.247 was not available this session).
:::
