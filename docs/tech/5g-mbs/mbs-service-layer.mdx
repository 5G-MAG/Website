...
Two items remain unverified, since TS 23.247, TS 26.501 and TS 33.501 were not available for this check: the "Media Streaming sessions over MBS User Services" clause of TS 26.501 (said to be Void), and the TS 33.501 Clause W.4.1.3 reference itself. Verify these against the specific versions you are targeting.
:::
