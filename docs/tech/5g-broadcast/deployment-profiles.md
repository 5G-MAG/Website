...
Later ETSI TS 103 720 versions extend the underlying feature set: v1.3.1 (in development) adds Band 108 (470 to 698 MHz) from 3GPP Release 18 and the Release 19 PMCH enhancements. For the release-by-release mapping, see [Standards: 5G Broadcast - TV, Radio and Emergency Alerts](/standards/5g-broadcast).
