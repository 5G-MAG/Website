...
<div>
<h1 class="topic-hero__title">Connectivity Quality with Network APIs</h1>
</div>
</header>
...
**Reference tools:** the 5G-MAG software implementation is on the developer portal under [Network APIs](/reference-tools/network-apis).
