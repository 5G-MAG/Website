...
<ul class="godeeper-card__links">
<li><a href="/standards/5g-mbs">Standards: 5G Multicast Broadcast Services</a></li>
</ul>
</div>
</div>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src={useBaseUrl('/docs/Reference_Tools_5G_Multicast_Broadcast.pdf')} title="5G Multicast Broadcast reference tools overview slide deck"></iframe>
</div>
...
For the 3GPP specification list grouped by layer, see [Standards: 5G Multicast Broadcast Services](/standards/5g-mbs). The [developer portal](/reference-tools/5g-mbs) covers what the reference software implements.
...
- [**User Services for the 5G Multicast-Broadcast Service (3GPP Release 17)**](./exchanges#user-services-for-the-5g-multicast-broadcast-service-3gpp-release-17)
...
- [5G Broadcast](./5g-broadcast): the LTE-based, free-to-air broadcast technology. A separate topic with a similar name.
- [5G Media Streaming](./5gms): the unicast delivery architecture whose user-service layer MBS extends.
- [Standards: 5G Multicast Broadcast Services](/standards/5g-mbs): the standards-tracking view of this topic.
- [Standards: Content Delivery Protocols](/standards/content-delivery): the FLUTE and ROUTE transport used by the MBS Object distribution method.
