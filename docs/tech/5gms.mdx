...
<ul class="godeeper-card__links">
<li><a href="/standards/5gms">Standards: 5G Media Streaming</a></li>
</ul>
</div>
</div>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src={useBaseUrl('/docs/Reference_Tools_5G_Media_Streaming.pdf')} title="5G Media Streaming reference tools overview slide deck"></iframe>
</div>
...
The AF also bridges to the 5G Core (PCF, NEF, BSF) to obtain policy, QoS and binding information — see [5G Core service consumers](/standards/5gms#5g-core-service-consumers-used-by-the-af) on the standards page for that interaction.
...
- [**Introduction to 5G Media Streaming (3GPP Release 16)**](./exchanges#introduction-to-5g-media-streaming-3gpp-release-16)
- [**Dynamic Policies for 5G Media Streaming (3GPP Release 16)**](./exchanges#dynamic-policies-for-5g-media-streaming-3gpp-release-16)
- [**5G Media Streaming over eMBMS (3GPP Release 17)**](./exchanges#5g-media-streaming-over-embms-3gpp-release-17)
- [**Edge Media Processing in 5G Media Streaming (3GPP Release 17)**](./exchanges#edge-media-processing-in-5g-media-streaming-3gpp-release-17)
...
- [**An Introduction**](./exchanges#advanced-media-delivery---an-introduction)
- [**Reminder on 5G Media Streaming**](./exchanges#advanced-media-delivery---reminder-on-5g-media-streaming)
- [**Common Client Metadata**](./exchanges#advanced-media-delivery---common-client-metadata)
- [**Multi-CDN Media Delivery**](./exchanges#advanced-media-delivery---multi-cdn-media-delivery)
- [**Multi-Access Media Delivery**](./exchanges#advanced-media-delivery---multi-access-media-delivery)
- [**Distributing encrypted and high-value content**](./exchanges#advanced-media-delivery---distributing-encrypted-and-high-value-content)
- [**Improved QoS support for Media Streaming services**](./exchanges#advanced-media-delivery---improved-qos-support-for-media-streaming-services)
- [**Media Streaming aspects of Network Slicing**](./exchanges#advanced-media-delivery---media-streaming-aspects-of-network-slicing)
- [**In-Session Unicast Repair for MBS/MBMS Obj. Distribution**](./exchanges#advanced-media-delivery---in-session-unicast-repair-for-mbsmbms-obj-distribution)
- [**Time Synchronization**](./exchanges#advanced-media-delivery---time-synchronization)
- [**Initial overview on Release 20**](./exchanges#advanced-media-delivery---initial-overview-on-release-20)

## Related

- [Multicast & Broadcast in 5G](./5g-mbs): point-to-multipoint delivery, whose user-service layer builds on 5GMS.
- [Standards: 5G Media Streaming](/standards/5gms): the primary standards view for this section, listing the 5GMS specifications 5G-MAG tracks and contributes to, including the BSF and PCF core-network functions the AF consumes.
- [Standards: UE Data Collection, Reporting and Event Exposure](/standards/data-collection): how devices report consumption and quality data used by 5GMS reporting.
- [Standards: DVB-I Services over 5G Systems](/standards/dvb-i): DVB-I service discovery and delivery over 5G, which reuses parts of 5GMS.
- [Standards: Real-Time Communications](/standards/rtc): low-latency, interactive media delivery related to the uplink direction of 5GMS.
