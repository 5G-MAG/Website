...
**Reference tools:** The 5G-MAG software implementation is on the Developer Portal under [Avatar Communications](/reference-tools/avatar).
...
<ul class="godeeper-card__links">
<li><a href="/reference-tools/avatar">Avatar Communications</a></li>
</ul>
</div>
</div>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src="pathname:///docs/Reference_Tools_Avatar.pdf" title="Slide deck: Avatar Communications reference tools"></iframe>
</div>

_Slide deck: Avatar Communications reference tools._
