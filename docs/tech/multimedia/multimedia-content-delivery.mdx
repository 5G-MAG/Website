...
<li><a href="/tech/standards/multimedia">Standards: Multimedia Delivery Protocols</a></li>
</ul>
</div>
</div>
...
<ul class="godeeper-card__links">
<li><a href="/reference-tools/multimedia">Project: Multimedia Content Delivery Protocols</a></li>
</ul>
</div>
</div>
