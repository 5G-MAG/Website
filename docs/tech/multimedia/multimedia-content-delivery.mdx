...
**Reference tools:** the [Multimedia Delivery Protocols reference tools](/reference-tools/multimedia) implement FLUTE and ROUTE for the delivery scenarios described below.
...
<li><a href="/standards/multimedia">Standards: Multimedia Delivery Protocols</a></li>
</ul>
</div>
</div>
...
<div class="pdf-embed-wrapper">
  <iframe loading="lazy" class="pdf-embed" src={useBaseUrl('/docs/Reference_Tools_Multimedia_delivery_protocols.pdf')} title="Multimedia Delivery Protocols reference tools overview slide deck"></iframe>
</div>
...
[Standards: Multimedia Delivery Protocols](/standards/multimedia) for the full chain.
:::
...
- [Standards: Multimedia Delivery Protocols](/standards/multimedia): the specification list for this topic
- [Multimedia Delivery Protocols Reference Tools](/reference-tools/multimedia): the software implementation
