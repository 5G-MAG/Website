...
**Key specifications:** IETF [RFC 6726](https://www.rfc-editor.org/rfc/rfc6726) (FLUTE), [RFC 9223](https://www.rfc-editor.org/rfc/rfc9223) (ROUTE), 3GPP [TS 26.346](https://www.3gpp.org/dynareport/26346.htm) (MBMS, FLUTE file delivery).
