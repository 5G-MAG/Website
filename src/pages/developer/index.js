    ...
    topics: [
      {
        ...
        icon: <ProjectIcon name="5G Media Streaming (5GMS)" />,
      },
      {
        ...
        icon: <ProjectIcon name="UE Data Collection, Reporting and Event Exposure" />,
      },
      {
      ...
      },
      {
        ...
        icon: <ProjectIcon name="DVB-I Services over 5G Systems" />,
      },
    ],
  },
  {
    ...
    topics: [
      {
        ...
        icon: <ProjectIcon name="5G Broadcast - TV and Radio Services" />,
      },
      {
    ...
    topics: [
      {
        ...
        icon: <ProjectIcon name="5G Multicast Broadcast Services (MBS)" />,
      },
      {
        title: '5G Core Service Consumers',
        desc: '5GC consumer reference tools',
        href: '/reference-tools/5g-core',
        icon: <ProjectIcon name="5G Core Service Consumers" />,
      },
    ],
  },
  {
    ...
    topics: [
      {
        ...
        icon: <ProjectIcon name="XR/3D Scenes with MPEG-I Scene Description" />,
      },
      {
        title: 'Avatar Communication with MPEG ARF',
        desc: 'MPEG ARF avatar communication',
        href: '/reference-tools/avatar',
        icon: <ProjectIcon name="Conversational Avatar Communication with MPEG ARF" />,
      },
    ],
  },
  {
    ...
    topics: [
      {
        ...
        icon: <ProjectIcon name="MPEG V3C Immersive Platform" />,
      },
      {
        title: 'Beyond 2D Evaluation Framework',
        desc: 'Video quality evaluation tools',
        href: '/testbeds/beyond-2d',
        icon: <ProjectIcon name="Beyond 2D Evaluation Framework" />,
      },
    ],
  },
  {
    ...
    topics: [
      {
        ...
        icon: <ProjectIcon name="CAMARA Connectivity Quality Management APIs" />,
      },
      {
      ...
      },
      {
        ...
        icon: <ProjectIcon name="AI Traffic Characterization" />,
      },
      {
        title: 'AI/ML Evaluation Framework',
        desc: 'AI/ML framework for media',
        href: '/testbeds/ai-ml',
        icon: <ProjectIcon name="AI/ML Evaluation Framework" />,
      },
    ],
  },
  {
